...
func RodMaximumProfitCut(prices []int, rodLength int) int {
	...
	// Code is deduced directly from the state-action-destination table on
	// page 26 (DSALG_RecursionDP). Note the use of state and destination indices
	// that relate directly to state and destination columns and their values
